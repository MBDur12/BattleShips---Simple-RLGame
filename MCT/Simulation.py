...
def randomly_place_ship(state, ship_length):
    ...
    while not valid:
        ...
        c1 = c2 = 0
        while abs(c1 - c2) != ship_length - 1: # check to see if coordinates are sufficiently apart to "fill in" the rest: e.g., ship length = 3, then 2 and 4 with 3 in between for the cooridantes.
